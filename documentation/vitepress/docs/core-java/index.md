...
* `editing` — Parsers and writers for the *editor* model (`EditableScriptParser`, `EditableScriptWriter`, `EditableTranslationParser`, `EditableHeaderParser`, and others), used by authoring tools such as Dialogue Branch Studio's visual editor.
